  ...
  return (
    <Grid container className="my-[4rem] flex flex-col items-center">
      <Grid container className="mx-auto w-[85%]">
        ...
        <AnimatedSection>
          <Grid item className="flex w-full flex-col gap-5 lg:col-span-2">
            ...
            >
              <AnimatedSection item animation="translateX(-200px)">
                <Card
            ...
            <AnimatedSection item className="grid w-full gap-3 lg:col-span-2">
            ...
            <AnimatedSection
              item
              className="flex w-full flex-col gap-5 lg:col-span-2"
            >
